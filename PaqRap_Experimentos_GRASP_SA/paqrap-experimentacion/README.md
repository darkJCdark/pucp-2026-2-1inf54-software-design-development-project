...
**Ejecución posterior (v5, 24-sep-2026):** PILOT se completó con 72/72 corridas `OK` y FORMAL con 400/400 `OK`; GRASP-v2 y SA-operational-v1.2 alcanzaron cobertura total. La formal usó el mismo límite máximo de 5 s, con bloqueos incluidos y mantenimiento preventivo/averías excluidos. SA terminó antes por su calendario térmico. La evidencia compacta y los hashes están en `evidencia/v5/`; las entradas v2–v4 anteriores permanecen como registro histórico de sus respectivas fases.
