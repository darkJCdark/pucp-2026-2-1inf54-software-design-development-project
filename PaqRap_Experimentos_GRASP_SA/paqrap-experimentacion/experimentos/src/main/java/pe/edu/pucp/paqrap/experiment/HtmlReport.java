...
public final class HtmlReport {
    ...
    public static void write(Path out,List<Map<String,String>> rows)throws IOException{
        ...
        h.append("<div class='note'><b>Interpretación:</b> “OK” significa que el evaluador común valida un plan que cubre TODA la demanda. Un plan parcial barato no es un éxito. “No se encontró” no demuestra que el problema sea imposible. Se comparan decisiones de planificación estática, no una simulación online de cinco días.</div><div class='cards'>");
